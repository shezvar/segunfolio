                ...
                <div className="relative isolate">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <div className='mx-auto'>
                            <div className=''>
                                <div className='relative w-full min-h-[1rem] mt-8 group'>
                                    <div className='bg-[#FDE8E3] p-16 grid'>
                                        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
                                        <img src='/images/cp-ob-login.png' alt='' className='rounded-lg h-full w-full block object-cover object-center' />
                                        <img src='/images/cp-ob-reg-1.png' alt='' className='rounded-lg h-full w-full block object-cover object-center' />
                                        <img src='/images/cp-ob-reg-2.png' alt='' className='rounded-lg h-full w-full block object-cover object-center' />
                                        <img src='/images/cp-ob-reg-3.png' alt='' className='rounded-lg h-full w-full block object-cover object-center' />
                                        <img src='/images/cp-ob-reg-4.png' alt='' className='rounded-lg h-full w-full block object-cover object-center' />
                                        <img src='/images/cp-ob-reg-5.png' alt='' className='rounded-lg h-full w-full block object-cover object-center' />
                                        <img src='/images/cp-ob-reg-6.png' alt='' className='rounded-lg h-full w-full block object-cover object-center' />
                                        <img src='/images/cp-ob-reg-7.png' alt='' className='rounded-lg h-full w-full block object-cover object-center' />
                                        </div>
                                    </div>
                                </div>
                            </div>
