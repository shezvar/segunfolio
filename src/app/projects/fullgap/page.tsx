...
const projectData = [
    { title: 'Operating System For The Freelance Economy', subtext: 'Designed to help creative professionals, particularly freelancers, manage their clients and projects effectively', imageUrl: '/images/sampleimage.png', alt: 'Fullgap', role1: 'Research', role2: 'Information Architecture', role3: '', role4: '', role5: '', platform1: 'Desktop', platform2: 'Mobile Responsive', platform3: '' },
]
