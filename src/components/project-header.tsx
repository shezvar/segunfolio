...
export default function ProjectHeader(props: { title: any; subtext: any; imageUrl: any; alt: any;  role1: any; role2: any; role3: any; role4: any; role5: any; platform1: any; platform2: any; platform3: any}) {
        ...
        <div className="">
            <div className='mx-auto flex items-center max-w-2xl md:max-w-3xl xl:max-w-7xl px-6 pb-[2rem] pt-56 sm:pt-60 lg:px-8 lg:pt-[20rem]'>
                <div className='w-full'>
                    ...
                    <h3 className='text-3xl font-normal mt-8 text-slate-600'>{subtext}</h3>
